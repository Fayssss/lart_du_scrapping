...
i = 0
	until i == 1800
	puts "Patientez ;), ca va arriver dans quelque instant, thans for your comprehension!"
	
	hash_array = {} # on fait un hash
	array_price = [] # on fait un tableau des prix
	array_name = [] # on fait un tableau des noms
	pages = Nokogiri::HTML(open("https://coinmarketcap.com/all/views/all/"))# url de la page "parent" 
